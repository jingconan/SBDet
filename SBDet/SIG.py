...
def parseToLil(f_name, first_k=None):
    """  parse the output of pcap2sigs to list of list (edge) format """
...
def mix(dataset1, dataset2, start):
    ...
    dataset1, dataset2 : tuple
        dataset1 = (sigs1, nodes1) and dataset2 = (sigs2, nodes2) are two
        datasets of SIGs.  It is assumed that len(sigs2) < len(sigs1). This
        function will mix sigs2 with a segment of sigs1 and return the mixed
        dataset
...
#     [2013-12-30 15:34:33]
##    Depreciated
##    Recommend to use pcap2sigs
##    https://github.com/hbhzwj/pcap2sigs
#######################################
